...
<article id="" class="layer-popup optionModi-pop">
	<section class="layer-popup-cont" tabindex="0">
		...
		<div class="layer-cont">
			...
			<div class="btnWrapBox">			
				<a href="javascript:;" class="btn d_layer_close">취소</a>
				<a href="javascript:;" class="btn fill">장바구니 담기</a>
			</div>
...
$(document).ready(function(){
	layerPopup.popupOpenNow('.optionModi-pop'); 
});
</script>
</body>
</html>