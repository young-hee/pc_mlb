			...
			<main class="contents memberWithdraw-wrap" id="contents">
				...
				<div class="memberSTcont boxCont04">
					<ul>
						...
						<li>
							<p>마일리지</p>
							<strong><a href="javascript:;" class="required">25,000</a>원</strong>
						</li>
						<li>
							<p>포인트</p>
							<strong><a href="javascript:;" class="required">5,000</a>원</strong>
						</li>
						<li>
							<p>쿠폰</p>
							<strong><a href="javascript:;" class="required">2</a>장</strong>
						</li>
					</ul>
					...
					<div class="memberODSTBox">
						<ul>
							<li>
								...
								<p>구매 <span class="required">2</span>건</p>
								<a href="javascript:;" class="btn fill">주문/배송 현황</a>
							</li>
							<li>
								<strong>취소/반품/교환</strong>
								<p>취소 <span class="required">2</span>건 / 반품 <span class="required">2</span>건 / 교환 <span class="required">2</span>건</p>
