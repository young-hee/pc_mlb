												...
												<tbody>
													<tr>
														...
														<td>
                                                            ...
                                                            <span class="btnTdArea"><a href="#lypopCuponSch" class="btn">쿠폰조회</a></span>
															...
															<ol>
																<li>
																	<dl>
																		...
																		<dd>
																			<ul class="text-list02 col-type01">
																				<li>매장픽업 주문 시간 및 매장의 재고 상황에 따라 당일 또는 1~2일 이내 매장픽업이 가능합니다. (영업시간기준)</li><li>매장픽업 주문의 경우 사은품을 제공하지 않습니다.</li><!--  2018.11.30 text 수정 -->
																			</ul>
																		</dd>
																	</dl>
																</li>
																...
																<li>
																	<dl>
																		<dt><span class="blind">03</span><em>상품매장픽업</em></dt><!--  2018.11.30 text 수정 -->
																		<dd>
																			<ul class="text-list02 col-type01">
																				<li>상품 수령 시, [상품준비완료]문자 혹은 디스커버리 APP의 바코드를 반드시 지참하시기 바랍니다.</li><li>16시 이후 결제되는 매장픽업 주문은 당일 수령이 불가합니다.</li><li>매장픽업 주문 시, [상품준비완료] 안내문자(알림톡)을 수신하신 익일 영업시간 이내로 상품을 수령하지 않을 경우 주문은 자동으로 취소됩니다.</li><!--  2018.11.30 text 수정 -->
																			</ul>
																		</dd>
																	</dl>
																</li>
