                    ...
                    <div class="orderContents orderComplete">                            
	                    <div class="orderComCont">
	                    	...
	                    	<div class="orderTxtBox">
	                    		...
	                    		<p>성공적으로 주문처리 되었습니다. 상품 주문내역과 결제금액을 확인하세요.<br>주문상세 내역 및 배송관련 정보는 마이페이지 > 주문정보 > 주문/배송 조회에서 확인하실 수 있습니다.<br />구매확정시 마일리지 5% 적립, 리뷰 작성시 포인트 증정 해드립니다.(포토 1,000원/텍스트 300원)</p><!-- 2018.11.30 text수정 -->
	                    	</div>
	                        ...
	                        <div class="orderInfoTable">
	                            <table class="board-write">
	                                ...
	                                <tbody>                                                
	                                    ...
	                                    <tr>
	                                    	<th rowspan="8" class="titSel lineB">결제내역</th>
	                                    	<th>상품가격</th>
	                                    ...
	                                    <tr>
	                                    	<th rowspan="5"">총 결제금액</th> <!-- 2019.02.01 lineB class 삭제 -->
	                                    ...
	                                    <tr>
											<th class="tMg0 fc_gray">실시간계좌결제(새마을금고중앙회)</th>
	                                    	<td class="fs_r tMg0 totalSel"><strong>365,200</strong>원</td>
	                                    </tr> 
	                                    <tr>
											<th class="tMg0 fc_gray">입금계좌</th>
	                                    	<td class="fs_r tMg0">558-12345-67891 (주)에프엔에프</td>
	                                    </tr> 
	                                    <tr><!-- 2019.02.01 lineB class 삭제 --> 
											<th class="tMg0 fc_gray">입금마감일시</th>
	                                    	<td class="fs_r tMg0">2018-10-25 24:00:00</td>
	                                    </tr>  
							...
							<div class="orderInfoTable">
	                      	 ...
	                      	 <div class="btn-wrap">
		                        ...
		                        <a href="/static/html/my/order_detail_general.jsp" class="btn-style02">주문내역 상세보기</a>
	                        </div>                        
