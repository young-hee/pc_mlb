...
<input type="hidden" name = "csoOrgztOrdAffInq.orgztOrdAffInqDetailTpCd" id="affTpCd" value="RTLSTOR_ESTBL"/>
...
<div class="board-write">
	...
	<tbody>
		...
		<td>
			<div class="select-style01 d_select">
				<button type="button" id="boardWriteSort" class="d_select_sel" style="width:152px;"><span>대리점개설</span></button>
				<ul>										 													
				<li class="selectBox"><a href="#none" onclick="return false;"  class="selCd"><c:out value ="대리점개설"  /></a></li>				
				</ul>
			</div>
	...
	<tr>
		...
		<td class='phoneBox'>
			...
			<span class="check-skin">
				<input type="checkbox" id="chkReply" name="agreeCheck" checked="checked" value="Y">
				<span>선택</span>
			</span>
	...
	<h3 class="title03"><spring:message code="helpdesk.affinquiry.noneLogin.agreementTerms.txt" /></h3>
	<div class="agree-section">	
		<%@ include file="/WEB-INF/views/helpdesk/include/stplatCont.view.jsp" %>						
		<ul class="agree-right">
			<li>
				<span class="rdo-skin">
					<input type="radio" id="rdoAgree1" name="rdoAgree">
					<span>선택</span>
				</span>
				<label for="rdoAgree1"><spring:message code="helpdesk.noneLogin.agreementTerms.aree.btn" /></label>
			</li>
			<li>
				<span class="rdo-skin">
					<input type="radio" id="rdoAgree2" name="rdoAgree" checked="checked">
					<span>선택</span>
				</span>
				<label for="rdoAgree2"><spring:message code="helpdesk.noneLogin.agreementTerms.disAree.btn" /></label>
			</li>
		</ul>
	</div>
<div class="btn-wrap">
...
<a id="layerPopup03ClickEvnt" href="#layerPopup02" style="display:none;" class="btn-style02 d_layer_open">동의</a>
</div>
</form>
	
<!--  동의확인 팝업 -->		
<article  id="layerPopup02"  class="layer-popup layer-type02">
<section  class="layer-popup-cont"  tabindex="0">
	<h2><spring:message code="helpdesk.popup.regconfirm.ttl" /></h2>
	<div class="layer-popup-wrap02">
		<p class="layer-txt"><spring:message code="helpdesk.popup.noneLogin.agreementTerms.suggestion.txt" /></p>
	</div>
	<div class="btn-wrap03">
		<a href="#" id="cancle3" class="btn-style02"><spring:message code="helpdesk.common.close.btn" /></a>
	</div>
	<div class="layer-popup-close">
		<button type="button" class="d_layer_close"><spring:message code="helpdesk.common.close.btn" /></button>
	</div>
</section>
</article>
</section>
	...
	$('#regBtn').click(function(){
		if(regProcess() == true){
			if($('input:radio[id=rdoAgree2]').is(':checked')){
				alertLayer(MESSAGES['helpdesk.js.popup.noneLogin.agreementTerms.suggestion.txt']);						
				return false;							
			}else{				
...
function regProcess(){
	...
	// 회사 유효성 체크						
	hlpValidate.nameValidation("boardCompany",21,"boardCompany-msg",4,MESSAGES['helpdesk.js.common.emptycompname.txt'],MESSAGES['helpdesk.js.common.limitcompname.txt']);	
	//담당자 유효성 체크
	hlpValidate.nameValidation("boardCompanyName",11,"boardCompanyName-msg",0,MESSAGES['helpdesk.js.common.emptyorgname.txt'],MESSAGES['helpdesk.js.common.limitorgname.txt']);			
	//연락처
	hlpValidate.phoneValidation("boardWriteContact","boardWriteContact2","boardWriteContact3","boardWriteContact-msg",1);															
	// 메일
	hlpValidate.emailValidation("boardWriteEmail","boardWriteEmail2","boardWriteEmail-msg",2);																			
