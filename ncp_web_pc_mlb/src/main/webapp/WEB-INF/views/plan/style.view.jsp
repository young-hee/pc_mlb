				...
				<section id="contents">
 					...
 					<div class="contents-type01-box03">
						<div class="temp-box09">
							...
							<div class="btn-wrap">
								<a href="/style/styleList" class="btn-style02"><spring:message code="display.style.text1"/></a>
							</div>
						</div>
					</div>
					...
					<div class="contents-type01-box03">
						<div class="temp-box08">
							<p class="temp-box08-txt01"><spring:message code="display.style.text2" /></p>
							<div class="item-list05">
								<ul>
					<c:forEach items="${style.styleList}" var="st" >
									<li>
										<div class="item-list05-img"><a href="/style/${st.evtNo }"><img src="${imageURL }${st.pcImgFileUrl }" alt="이미지1"></a></div>
