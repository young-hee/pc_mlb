...
<%-- 					<li><span class="txt"><em class="t">${dpth1Nm}</em></span></li> --%>
					<li>
						<span class="txt"><em class="t">${dpth2Nm}</em> <c:if test="${fn:length(dpth3) eq 0}"></c:if><a href="javascript:;" class="bt">하위메뉴열기</a></span>
						<div class="subs">
							<ul class="list">
								...
								<li><a href="javascript:cateLink('${param.ctgryNoDpth1}', '1', '${param.ctgrySectCd}', '${param.ctgryNoDpth1}');" class="lk"><em class="t"><spring:message code="display.category.text.all" /></em> </a></li>
							...
							<c:forEach items="${ctgryContt}" var="contt">
								...
								<c:if test="${contt.conttTpCd eq 'IMG_BANNER'}">
									...
									<li class="swiper-slide">
										<a href="${contt.conttCnncUrl}">
											<img class="vs-img" src="${_image}${contt.imgFileUrl}/${contt.imgFileNm}/dims/resize/1920x560" alt="${contt.imgAltrtvCont}" >
										</a>
									</li>
