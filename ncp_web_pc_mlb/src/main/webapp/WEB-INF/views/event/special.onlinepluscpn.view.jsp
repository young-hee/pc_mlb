...
<div class="evt-wrap">
	...
	<ul class="blind">
		<li>- 본 행사는 이벤트 하단 상품에만 한정되는 MLB 카카오 플러스친구 대상 전용 이벤트입니다.</li>
		<li>- 15% 할인쿠폰은 ID당 횟수 제한 없이 다운 받을 수 있으며, 주문 시 장바구니 쿠폰으로 적용 가능합니다.</li>
		<li>- 본 이벤트는 MLB 내부 사정에 의해 변경 또는 중단 될 수 있습니다.</li>
	</ul>
	<img src="https://prd-static-fnf-online-mall.s3.ap-northeast-2.amazonaws.com/webresource/mlb-korea/motioneye/2020/01_sweatshirts/pc/content3.jpg" alt="" />
</div>
<!-------------------- //기획전 소스 END -------------------->
					</div>
				</section>
	...
	function goDownCoupon(type) {
		...
		$.ajax({
			...
			data : {'evtNo': evtNo, 'mbr.mbrNm': mbrNm, 'cpnPrmNm':'PR202001170000595', 'evtDuplctYn':'Y'},
