...
<script type="text/javascript" src="${_resourceURL}static/js/member/join.test.js?v=${_version}"></script>
		...
		<div class="container">
			...
			<main class="contents" id="contents">
				...
				<div class="join-wrap">
					...
					<div class="top-info">
						<div class="hdt">F&amp;F 통합회원 가입 <font color="red"><b>TEST</b></font></div>
