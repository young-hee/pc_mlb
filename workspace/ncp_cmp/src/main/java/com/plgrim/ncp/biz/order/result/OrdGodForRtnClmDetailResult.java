...
public class OrdGodForRtnClmDetailResult extends AbstractResult {
	/**
     *
     */
    ...
    private String upperGodNo;                          //세트상품 마스터 상품 번호
    ...
    private String setGodNm;                           	//세트상품 명
    ...
    private String clmYn;                               //클레임 가능 여부
    ...
    private java.math.BigDecimal stdrCrncyAmt;			//사이트 기준 금액
    ...
    private java.math.BigDecimal webPntUseSumAmt;      //P포인트 (웹포인트)
    ...
    private java.lang.Long ordQty;                  	//주문수량
    ...
    private String giftRtrvlTgtYn;	//사은품회수대상여부

    private java.lang.Long susunOrdQty;                  	//수선수량
    private java.lang.Long susunOrdSetQty;                  	//셋트상품 수선수량
    
    private String ordDt;

    private String boRepairGridHtml;

    private String setGodNo;

    private String ordGodWrapSvcYn; // 선물포장 서비스 여부
     ...
     * 교환 가능한 상품/옵션 정보
     */
    private GoodsOptionResult goodsOptionResult;
    
    private String changeDlvShopId; //교환시 기준wms
}