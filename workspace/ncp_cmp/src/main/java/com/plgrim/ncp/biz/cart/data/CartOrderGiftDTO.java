...
public class CartOrderGiftDTO extends AbstractDTO {

	/**
	 * 
	 */
    private static final long serialVersionUID = -6560420846804469293L;
	/*
	 * ---------------------------------------------------------------------
	 * Instance fields.
	 * ---------------------------------------------------------------------
    ...
    /** The gift bsk god. */
    List<BskGod> giftBskGod;
    
    /** The gift god. */
    List<BskGodExtend> giftGod;
	/*
	 * ---------------------------------------------------------------------
	 * Constructors.
	 * ---------------------------------------------------------------------
