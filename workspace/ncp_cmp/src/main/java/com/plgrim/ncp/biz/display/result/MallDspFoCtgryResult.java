...
public class MallDspFoCtgryResult extends AbstractResult{

	private static final long serialVersionUID = -2589991728284041406L;

	List<MallDspFoCtgryResult> mallDspFoCtgryResults;
	//카테고리 정보
	DspCtgry ctgryInfo;
	...
	private DspCtgryGodFoResult dspCtgryGodFoResult;
	
	/**
	 * 카테고리별 사이즈
	 */
	private List<List<DspCtgryGodFoResult>> sizeFilters;
