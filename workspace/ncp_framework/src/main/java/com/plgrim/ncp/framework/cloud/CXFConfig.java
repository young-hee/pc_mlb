...
import com.plgrim.ncp.framework.exception.api.RestfulExceptionMapper;

import lombok.extern.slf4j.Slf4j;

/**
 * CXF Server와 client configuration bo, fo was는 client만 interface는 server와
 * client 모두
 * 
...
public class CXFConfig {
	...
	public JacksonJsonProvider jsonProvider() {
		...
		// disable to exlude null in json serialize
	...
	@PropertyCondition(value = "ncp_base.cxf.server.enable")
	@Bean
