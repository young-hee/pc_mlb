...
import com.plgrim.ncp.framework.data.ExcelDownLoadResult;
...
public class ExcelDownloadView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	...
    	ExcelDownLoadResult result = (ExcelDownLoadResult) model.get(ExcelDownLoadResult.MODEL_NAME);
        ...
        List<List<String>> headers = result.getHeaders();
        ...
        int headerListCnt = 0;
        for (List<String> elementList : headers) {
        	HSSFRow header = sheet.createRow(headerListCnt);
        	int headerCount = 0;
