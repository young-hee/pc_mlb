...
public class ExcelResult {
    ...
    /* 헤더 추가 */
    public void addHeader(String element) throws Exception {
    ...
    /* Model에 ROW 데이터를 담는다. */
	public <T extends Map<String, ? extends Object>> void parse(Model model, T context) throws Exception {
		
		for (String key : context.keySet()) {
            content.add(context.get(key));
        }
