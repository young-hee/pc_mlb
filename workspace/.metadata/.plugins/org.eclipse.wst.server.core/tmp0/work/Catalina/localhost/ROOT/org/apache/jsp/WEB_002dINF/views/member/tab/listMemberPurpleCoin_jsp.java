 ...
 * Generated at: 2020-01-22 02:37:34 UTC
...
public final class listMemberPurpleCoin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    com.plgrim.ncp.framework.utils.JSPEnvHelper.setDomainVariables(request, pageContext);
      ...
      out.write("\"/>\n              \t<input type=\"hidden\" name=\"mbrNo\" id=\"tabMbrNo\"/>\n              </form>\n\t\t\t  <div class=\"buttons-wrap\"><a href=\"javascript:undefined;\" class=\"btn purpleCoinChange\">P포인트 변경</a></div>\n              <table class=\"basic\">\n                <colgroup>\n                  <col class=\"col_01 head\">\n                  <col class=\"col_02\">\n                </colgroup>\n                <tbody>\n                  <tr>\n                    <th>총 P포인트</th>\n                    <td><span class=\"totalAmt\">0</span>");
      if (_jspx_meth_spring_005fmessage_005f0(_jspx_page_context))
        return;
      out.write("</td>\n\t\t\t\t    <th>가용 코인</th>\n\t\t\t\t    <td><span class=\"usefulAmt\">0</span>");
      if (_jspx_meth_spring_005fmessage_005f1(_jspx_page_context))
        return;
      out.write("</td>\n\t\t\t\t    <th>적립 예정</th>\n\t\t\t\t    <td><span class=\"accmlPrearngeAmt\">0</span>");
      if (_jspx_meth_spring_005fmessage_005f2(_jspx_page_context))
        return;
      out.write("</td>\n\t\t\t\t    <th>소멸 예정</th>\n\t\t\t\t    <td><span class=\"extshPrearngeAmt\">0</span>");
      if (_jspx_meth_spring_005fmessage_005f3(_jspx_page_context))
        return;
      out.write("</td>\n                  </tr>\n                </tbody>\n              </table>\n              <div class=\"grid-header mt20\" id=\"gridPurpleCoinHeader\">\n                <p class=\"title\">\n\t\t\t\t\tP포인트 적립/사용내역\n\t            \t<sub class=\"desc\">(");
      if (_jspx_meth_spring_005fmessage_005f4(_jspx_page_context))
        return;
      out.write(" <span class=\"bold orange\">0</span>");
      if (_jspx_meth_spring_005fmessage_005f5(_jspx_page_context))
        return;
      out.write(")</sub>\n\t            </p>\n              </div>\n              <div class=\"grid-wrap\">\n                <div id=\"gridPurpleCoin\" style=\"height: 400px; width:100%\"></div>\n              </div>\n            </div>\n <script type=\"text/javascript\">\n\t$(\"#tabMbrNo\").val(mbrNo);\n \t// 그리드 생성\n\tvar grid1 = new GridUtil().parentId(\"gridPurpleCoin\");\n\tvar gridForm = \"frmTab\";\n\tvar gridHeader = \"gridPurpleCoinHeader\";\n\tvar gridUrl = \"/mb/member/purpleCoin\";\n\t\n\t// 그리드 Header Option\n\tvar gridHeaderOptions = {serializeForm:gridForm, hasColumnSelector : false};\n\n\tif('");
      if (_jspx_meth_ncp_005fboButtonAuth_005f0(_jspx_page_context))
        return;
      out.write("' == \"true\"){\n\t\t$.extend(gridHeaderOptions, {hasExcelDlBtn:true, excelDownloadURL:gridUrl+'/excel'});\n\t}\n\n\tvar linkAction = function(cell, rowIndex){\n\t\taddrRowId = grid1.grid.getRowId(rowIndex);\n\t\tvar no = grid1.grid.cells(addrRowId, grid1.grid.getColIndexById(\"mbrWebpntHist.webpntNos\")).getValue();\n\t\tif(no == null){\n\t\t} else if(no.indexOf('OD') > -1){ // 주문\n\t\t\twindow.open(\"");
      if (_jspx_meth_c_005furl_005f0(_jspx_page_context))
        return;
      out.write("?ordNo=\"+no, \"_blank\", \"scrollbars=1,resizable=1,height=900,width=1750\");\n\t\t} else if(no.indexOf('EV') > -1){ // 이벤트\n            window.open(\"");
      if (_jspx_meth_c_005furl_005f1(_jspx_page_context))
        return;
      out.write("?evtNo=\" + no, \"_blank\", \"scrollbars=1,resizable=1,height=900,width=1750\");\n\t\t} else if(no.indexOf('CL') > -1){ // 클레임\n            window.open(\"");
      if (_jspx_meth_c_005furl_005f2(_jspx_page_context))
        return;
      out.write("/\" + no, \"_blank\", \"scrollbars=1,resizable=1,height=900,width=1750\");\n        } else if(no.indexOf('GM') > -1 ){ // 상품\n            window.open(\"");
      if (_jspx_meth_c_005furl_005f3(_jspx_page_context))
        return;
      out.write("?mode=edit&godNo=\"+no, \"_blank\", \"scrollbars=1,resizable=1,height=900,width=1750\");\n        }\n\t};\n\n\tgrid1.columnRule({mode : 'ro', align : 'center'})   \n//\t\t.column({columnId : 'mbrWebpntHist.webpntResnCd'            , type : 'ro'  , align : 'center', width : '100', sorting : 'str' , headerLabel:'사유'})\n\t\t.column({columnId : 'mbrWebpntHist.webpntResnNm'            , type : 'ro'  , align : 'center', width : '100', sorting : 'str' , headerLabel:'사유'})\n\t\t.column({columnId : 'mbrWebpntHist.webpntNos'  \t\t\t\t, type : 'cLink'  , align : 'center'  , width : '200'  , sorting : 'str' , headerLabel:'주문/이벤트/클레임', linkAction: linkAction})\n\t\t.column({columnId : 'mbrWebpntHist.resnDscr'\t\t\t\t, type : 'ro'  , align : 'left' , width : '*', sorting : 'int' , headerLabel:'내역'})\n\t\t.column({columnId : 'mbrWebpntHist.webpntStatCd'     \t\t, type : 'ro'  , align : 'center', width : '0', sorting : 'str' , headerLabel:'상태'})\n\t\t.column({columnId : 'mbrWebpntHist.webpntStatNm'     \t\t, type : 'ro'  , align : 'center', width : '80', sorting : 'str' , headerLabel:'상태'})\n");
      out.write("\t\t.column({columnId : 'mbrWebpntHist.webpntAmt'     \t\t\t, type : 'ro'  , align : 'center', width : '150', sorting : 'str' , headerLabel:'금액'})\n\t\t.column({columnId : 'mbrWebpntHist.useDtStr'                , type : 'ro'  , align : 'center', width : '160', sorting : 'str' , headerLabel:'유효기간'})\n\t\t.column({columnId : 'mbrWebpntHist.occurDtStr'     \t\t\t, type : 'ro'  , align : 'center', width : '145', sorting : 'str' , headerLabel:'처리일'})\n\t\t.setHeader(gridHeader, gridHeaderOptions)\n\t\t.setEnableOrderNum(true)\n\t\t.init();\n\n\n\t// 웹 적립금 목록 성공\n\tvar searchCallbackSuccess = function(result){\n\t\tvar total = result.mbrWebpntAmt.usefulAmt + result.mbrWebpntAmt.accmlPrearngeAmt;\n\t\t$(\".totalAmt\").html(mfn_comma((isNaN(total) ? 0 : total).toString()) );\t// 웹적립금 총액\n\t\t$(\".usefulAmt\").html(mfn_comma((result.mbrWebpntAmt.usefulAmt).toString()) );\t// 웹적립금 총액\n\t\t$(\".accmlPrearngeAmt\").html(mfn_comma((result.mbrWebpntAmt.accmlPrearngeAmt).toString()) );\t// 웹적립금 총액\n\t\t$(\".extshPrearngeAmt\").html(mfn_comma((result.mbrWebpntAmt.extshPrearngeAmt).toString()) );\t// 웹적립금 총액\n");
      out.write("\t}\n\t\t\n\t// 페이지 로딩 후 바로 조회\n\tmfn_gridSearch(gridUrl, grid1, gridHeader, searchCallbackSuccess);\n\n\tvar callbackSearch = function(){\n\t\tmfn_gridSearch(gridUrl, grid1, gridHeader, searchCallbackSuccess);\n\t}\n\n\t$('.purpleCoinChange').click(function(){\n\t\tmfn_openPurpleCoinPopup($('#mbrNo').val(), $('#mbrId').val(), $('#mbrNm').val());\n\t});\n\n\tvar mfn_openPurpleCoinPopup = function(mbrNo, mbrId, mbrNm){\n\t\tvar url = \"/sc/godevl/editWebPnt\";\n\t\tvar width = \"550\";\n\t\tvar height =\"550\";\n\t\tvar left=(screen.width-width)/2;\n\t\tvar top=(screen.height-height-60)/2;\n\t\tOpenParamWindow({\"url\"   : url,\n\t\t\t\"name\"  : \"openPurpleCoinPopup\",\n\t\t\t\"width\" : width,\n\t\t\t\"height\": height,\n\t\t\t\"left\": left,\n\t\t\t\"top\": top,\n\t\t\t\"param\" : [\n\t\t\t\t{\"name\" : 'mbrNo', 'value' : mbrNo},\n\t\t\t\t{\"name\" : 'mbrId', 'value' : mbrId},\n\t\t\t\t{\"name\" : 'mbrNm', 'value' : mbrNm},\n\t\t\t\t{\"name\" : 'type', 'value' : 'mbrDetail'}\n\t\t\t]\n\t\t});\n\t}\n\n </script>            ");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(17,55) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f0.setCode("MemberController.unit.purpleCoin");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(19,44) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f1.setCode("MemberController.unit.purpleCoin");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(21,51) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f2.setCode("MemberController.unit.purpleCoin");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(23,51) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f3.setCode("MemberController.unit.purpleCoin");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(30,33) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(30,120) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ncp_005fboButtonAuth_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(48,5) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_ncp_005fboButtonAuth_005f0.setUrl("/mb/member/purpleCoin/list");
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(48,5) name = auth type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_ncp_005fboButtonAuth_005f0.setAuth("E");
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(48,5) name = display type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(57,16) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f0.setValue("/od/popupOrder");
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(59,25) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f1.setValue("/pm/event/editEvent");
  ...
  private boolean _jspx_meth_c_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(61,25) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f2.setValue("/od/claim/partCancel/register");
  ...
  private boolean _jspx_meth_c_005furl_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/tab/listMemberPurpleCoin.jsp(63,25) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f3.setValue("/gd/goods/editGoods");
