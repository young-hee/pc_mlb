 ...
 * Generated at: 2019-12-13 08:53:17 UTC
...
public final class newBatch_005fp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    com.plgrim.ncp.framework.utils.JSPEnvHelper.setDomainVariables(request, pageContext);
      ...
      if (_jspx_meth_c_005furl_005f0(_jspx_page_context))
        return;
      out.write("\"></script>\r\n<div class=\"popup-wrap\">\r\n    <div class=\"popup-header\">\r\n      <h1>배치 프로세스 등록</h1>\r\n    </div>\r\n    <form id=\"fAdd\" name=\"fAdd\" >\r\n    \t<div class=\"popup-body\">\r\n\t      <div class=\"section\">\r\n\t        <table class=\"basic\">\r\n\t          <colgroup>\r\n\t            <col class=\"head\">\r\n\t            <col>\r\n\t          </colgroup>\r\n\t          <tbody>\r\n\t          \t<tr>\r\n\t              <th><label for=\"\">배치 ID</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchClassId\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">그룹명</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchGrpNm\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">작업명</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchNm\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">스케쥴</label> <span class=\"essential\">*</span></th>\r\n");
      out.write("\t              <td><input type=\"text\" name=\"batchExecutCyclCont\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">실행 URL</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchBegUrl\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">실행 파라메터</label></th>\r\n\t              <td><input type=\"text\" name=\"batchPrmtrCont\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">중지 URL</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchEndUrl\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">실패이력 실행 URL</label> <span class=\"essential\">*</span></th>\r\n\t              <td><input type=\"text\" name=\"batchRebegUrl\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">단건 실행 URL</label></th>\r\n\t              <td><input type=\"text\" name=\"indExecutUrl\" class=\"full\"></td>\r\n");
      out.write("\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">단건 실행 파라메터</label></th>\r\n\t              <td><input type=\"text\" name=\"indExecutPrmtrCont\" class=\"full\"></td>\r\n\t            </tr>\r\n\t            <tr>\r\n\t              <th><label for=\"\">간략설명</label> <span class=\"essential\">*</span></th>\r\n\t              <td><textarea name=\"batchDscr\" id=\"batchDscr\" cols=\"30\" rows=\"10\"></textarea></td>\r\n\t            </tr>\r\n\t          </tbody>\r\n\t        </table>\r\n\t      </div>\r\n\t      <div class=\"buttons-wrap center-bottom\">\r\n\t        <a href=\"javascript:undefined;\" id=\"btnAddBatch\" class=\"btn btn-navy\" ");
      if (_jspx_meth_ncp_005fboButtonAuth_005f0(_jspx_page_context))
        return;
      out.write(">저장</a>\r\n\t        <a href=\"javascript:undefined;\" id=\"btnCloseWindow\" class=\"btn\" onclick=\"window.close();\">닫기</a>\r\n\t      </div>\r\n\t    </div>\r\n    </form>\r\n</div>\r\n  \r\n<script type=\"text/javascript\">\r\n\r\n\tjQuery(document).ready(function() {\r\n\t\t  jQuery(\"#fAdd\").submit(function(e) { actionJS.doCheckValues(); e.preventDefault(); });\r\n\t\t  jQuery(\"#btnAddBatch\").click(function(e) { actionJS.doCheckValues(); e.preventDefault(); });\r\n\t});\r\n\t\r\n\tvar actionJS = {\r\n\t\tinitialize: function(cfg) {\r\n\t    }, \r\n\t    doCheckValues:function() {\r\n\t    \tthis.batchClassId = $(\"#fAdd input[name='batchClassId']\").val().trim();\r\n\t    \tthis.batchNm = $(\"#fAdd input[name='batchNm']\").val().trim();\r\n\t    \tthis.batchGrpNm = $(\"#fAdd input[name='batchGrpNm']\").val().trim();\r\n\t    \tthis.batchExecutCyclCont = $(\"#fAdd input[name='batchExecutCyclCont']\").val().trim();\r\n\t    \tthis.batchBegUrl = $(\"#fAdd input[name='batchBegUrl']\").val().trim();\r\n\t    \tthis.batchEndUrl = $(\"#fAdd input[name='batchEndUrl']\").val().trim();\r\n\t    \tthis.batchRebegUrl = $(\"#fAdd input[name='batchRebegUrl']\").val().trim();\r\n");
      out.write("\t    \tthis.indExecutUrl = $(\"#fAdd input[name='indExecutUrl']\").val().trim();\r\n\t    \tthis.batchDscr = $(\"#fAdd textarea[name='batchDscr']\").val().trim();\r\n\t    \tthis.batchPrmtrCont = $(\"#fAdd input[name='batchPrmtrCont']\").val().trim();\r\n\t    \tthis.indExecutPrmtrCont = $(\"#fAdd input[name='indExecutPrmtrCont']\").val().trim();\r\n\t    \t\r\n\t    \tif(this.batchClassId == '') {\r\n\t    \t\talert(\"배치ID 를 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchGrpNm == '') {\r\n\t    \t\talert(\"그룹명을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchNm == '') {\r\n\t    \t\talert(\"배치명을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchExecutCyclCont == '') {\r\n\t    \t\talert(\"스케쥴을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchBegUrl == '') {\r\n\t    \t\talert(\"실행 URL 을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchEndUrl == '') {\r\n\t    \t\talert(\"중지 URL 을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t} else if(this.batchRebegUrl == '') {\r\n\t    \t\talert(\"실패이력 실행 URL 을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n");
      out.write("\t    \t} else if(this.batchDscr == '') {\r\n\t    \t\talert(\"배치 설명을 입력해야 합니다.\");\r\n\t    \t\treturn false;\r\n\t    \t}\r\n\t    \t\r\n\t    \tthis.doAddBatchJob();\r\n\t    }, \r\n\t\tdoAddBatchJob:function() {\r\n\t\t\tvar params = {}; \r\n\t\t\t\r\n\t\t\tparams['batchClassId'] = this.batchClassId;\r\n\t\t    params['batchNm'] = this.batchNm;\r\n\t\t    params['batchGrpNm'] = this.batchGrpNm;\r\n\t\t    params['batchExecutCyclCont'] = this.batchExecutCyclCont;\r\n\t\t    params['batchBegUrl'] = this.batchBegUrl;\r\n\t\t    params['batchEndUrl'] = this.batchEndUrl;\r\n\t\t    params['batchRebegUrl'] = this.batchRebegUrl;\r\n\t\t    params['indExecutUrl'] = this.indExecutUrl;\r\n\t\t    params['batchDscr'] = this.batchDscr;\r\n\t\t    params['batchPrmtrCont'] = this.batchPrmtrCont;\r\n\t\t    params['indExecutPrmtrCont'] = this.indExecutPrmtrCont;\r\n\t\t     \t\t\r\n\t\t    var data = comAjaxJS.callAjax(\"/sc/batch/addBatch.json\",params);\r\n\r\n\t\t\tif( comAjaxJS.isSucess(data)){ \r\n\t\t\t\talert (\"Batch Job 등록 완료.\");\r\n\t\t\t\twindow.opener.actionJS.doSearch();\r\n\t\t\t\twindow.close();\r\n\t\t\t}\r\n\t\t}\r\n\t};\r\n\t\r\n</script>\r\n  ");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/commons/batch/newBatch_p.jsp(3,36) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ncp_005fboButtonAuth_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/commons/batch/newBatch_p.jsp(65,79) name = auth type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
