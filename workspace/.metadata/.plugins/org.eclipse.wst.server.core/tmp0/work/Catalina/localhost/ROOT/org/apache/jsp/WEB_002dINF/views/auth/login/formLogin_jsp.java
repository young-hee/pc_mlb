 ...
 * Generated at: 2019-12-10 02:23:16 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.auth.login;
...
String reqUrl = ContextService.getCurrentRequest().getRequestURL().toString().toLowerCase();
String requestUri = urlPathHelper.getOriginatingRequestUri(ContextService.getCurrentRequest());
boolean scrLock = false;
System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> BO Login...in");
System.out.println("reqUrl :: "+reqUrl);
System.out.println("requestUri :: "+requestUri);
if( reqUrl.indexOf("withus.plgrimshop") > -1 && (requestUri.equals("/login") || requestUri.equals("/main")) ) { 
      out.write("\n\t<script>\n\t\t$(document).ready(function() {\n\t\t\tdocument.location.href= \"/pologin\";\n\t\t});\n\t</script>\n");
 } else if( reqUrl.indexOf("bo.plgrimshop") > -1 && (requestUri.equals("/pologin") || requestUri.equals("/pomain")) ) { 
 ...
 if(scrLock){ 
      ...
      if (_jspx_meth_c_005furl_005f17(_jspx_page_context))
        return;
      out.write("';\n  \t}\n    \n  </script>  \n</head>\n\n<body class=\"top login\">\n \n  <div id=\"wrap\">\n    <div id=\"header\">\n      <a href=\"/\"><span id=\"logo\">플그림 Back Office</span></a>\n    </div>\n    <div class=\"login-form\">\n    <form id=\"fLogin\" method=\"POST\" action=\"");
      if (_jspx_meth_c_005furl_005f18(_jspx_page_context))
        return;
      out.write("\">\n    \n      <p class=\"header\">Login</p>\n      <div class=\"lgoin-input\"><select name=\"boSiteId\" >\n        <option value=\"BO\">BO</option>\n");
      out.write("\n      </select></div>\n      <div class=\"lgoin-input\"><input type=\"text\" id=\"userId\" name=\"userId\" value=\"\" placeholder=\"ID\"></div>\n      <div class=\"lgoin-input\"><input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" value=\"\" placeholder=\"PASSWORD\"></div>\n      <input type=\"submit\" value=\"로그인\" class=\"submit\">\n      <span class=\"checkbox\">\n        <input type=\"checkbox\" id=\"saveId\" ><label for=\"saveId\">아이디 저장</label>\n      </span>\n      <!-- <a href=\"javascript:undefined;\" class=\"signup\">아이디신청</a> -->\n<!--       <p class=\"help\">관리자 문의 : <span class=\"name\">홍길동</span> <a href=\"tel:1588-0000\">1588-0000</a></p> -->\n      <p class=\"footer\">COPYRIGHT(c) 2015 F&F ALL RIGHTS RESERVED</p>\n    \n    </form>\n    </div>\n    \n  </div>\n\n</body>\n</html>\n");
 	
	String userStatus = (String)ContextService.getCurrentRequest().getSession().getAttribute("adminStatus");
    Integer loginFailCnt = (Integer)ContextService.getCurrentRequest().getSession().getAttribute("loginFailCnt");
    System.out.println("[JSP] userStatus :: "+userStatus);
	System.out.println("[JSP] loginFailCnt :: "+loginFailCnt);
	if(userStatus==null)userStatus="";
	if(loginFailCnt==null)loginFailCnt=0;

      out.write("\n<script>\nvar loginFailCnt = ");
      out.print(loginFailCnt);
      out.write(";\n\n    $(document).ready(function () {\n\n        <!-- 인증 처리가 완료될 경우 -->\n        ");
      out.write("\n\n        if('");
      out.print(userStatus);
      out.write("' == 'APRV_WAIT'){\n        \talert('승인대기 상태인 아이디입니다.');\t\n        }else if(loginFailCnt > 0 && loginFailCnt < 3){\n\t\t\talert('아이디 또는 패스워드가 틀립니다.');\n        }else if(loginFailCnt == 5){\n\t\t\t//alert(loginFailCnt+'번 로그인 실패하셨습니다.(비밀번호가 초기화 되었습니다.)\\n비밀번호 찾기를 통해서 임시비밀번호 발급받을 수 있습니다.');\n\t\t\talert(loginFailCnt+'번 로그인 실패하셨습니다.(비밀번호가 초기화되어 메일로 발송되었습니다.)');\n        }else if(loginFailCnt > 5){\n\t\t\t//alert('비밀번호가 초기화 되어 더 이상 로그인 불가 합니다.\\n비밀번호 찾기를 통해서 임시비밀번호 발급받을 수 있습니다.');\n\t\t\talert('비밀번호가 초기화 되어 더 이상 로그인 불가 합니다.');\n        }else if(loginFailCnt >= 3){\n\t\t\talert('연속 5회 로그인 실패 시 해당 비밀번호를 사용할 수 없습니다.\\n로그인 실패 : '+loginFailCnt+'회');\n\t    }else if('");
      out.print(userStatus);
      out.write("' == 'DRMC'){\n\t    \talert(\"휴면상태인 아이디입니다. 관리자에게 문의하세요.\");\n\t    }\n\n        \n        jQuery(\"#fLogin\").submit(function(e) { \n        \tvar expdate = new Date();\n        \tif (  $(\"#fLogin #saveId\").is(\":checked\")){\n        \t\texpdate.setTime(expdate.getTime() + 1000 * 3600 * 24 * 30); // 30일\n        \t}else{\n        \t\texpdate.setTime(expdate.getTime() - 1); // 쿠키 삭제조건\n        \t}\n        \tsetCookie(\"saveid\", $(\"#fLogin #userId\").val(), expdate);\n        });\n        \n        $('#fLogin #userId').val( getCookie(\"saveid\") );\n        if(  getCookie(\"saveid\") != \"\") $('#fLogin #saveId').attr(\"checked\", true);\n        if(  getCookie(\"saveid\") == \"\") {\n        \t$('#fLogin #userId').val( '' );\n        \t$('#fLogin #password').val( '' );\n        }\n    });\n    \n    function setCookie (name, value, expires) {\n        document.cookie = name + \"=\" + escape (value) + \"; path=/; expires=\" + expires.toGMTString();\n    }\n\n    function getCookie(Name) {\n        var search = Name + \"=\";\n        if (document.cookie.length > 0) { // 쿠키가 설정되어 있다면\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(46,54) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f0.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}images/favicon/favicon_bo.ico", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(47,45) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f1.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}images/favicon/favicon_bo.ico", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(49,47) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f2.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}css/reset.css", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(50,47) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f3.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}css/dhtmlx/test_skin/dhtmlx.css", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(51,47) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f4.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}plugin/sumoselect/sumoselect.css", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(52,47) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f5.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}css/style.css", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(53,47) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f6.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}plugin/nanoscroller/nanoscroller.css", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f7(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(55,37) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f7.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/dhtmlx/codebase/dhtmlx.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f8(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(56,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f8.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/jquery.min.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f9(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(57,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f9.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}plugin/sumoselect/jquery.sumoselect.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f10(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(58,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f10.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/jquery.pagination.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f11(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(59,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f11.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/jquery.paging.min.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f12(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(60,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f12.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/TabbarUtil.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f13(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(61,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f13.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/GridUtil.js?timestamp=20171128", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f14(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(62,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f14.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/InputUtils.js", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f15(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(63,38) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f15.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${_resourceURL}js/common.js?timestamp=20171128", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005furl_005f16(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(66,25) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f17(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(80,30) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f18(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/auth/login/formLogin.jsp(93,44) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f18.setValue("/loginProcess");
