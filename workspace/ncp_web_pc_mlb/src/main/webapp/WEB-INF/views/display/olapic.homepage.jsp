...
<c:choose>
	<c:when test='${_locale eq "en"}'>
		...
		<c:set var = "_olapic_data_instance" value ="d9e9046ceaaf9610efc4a6acf50d9e66" />
	...
	<c:when test='${_locale eq "zh"}'>
		...
		<c:set var = "_olapic_data_instance" value ="6a2bfb60effe663589ec9eaeb3561483" />
	...
	<c:otherwise>
		...
		<c:set var = "_olapic_data_instance" value ="203ab07343cd0866334c213c2b2f948a" />
