...
<article id="" class="layer-popup textReview-pop">
						...
						<tr>
							<td colspan="2">
								<div class="goodsreviewBox">
									<p class="txt13-666 pdb15">리뷰 작성 시, 온라인몰에서 사용 가능한 포인트를 적립해 드립니다. (텍스트리뷰 300포인트, 포토리뷰 1,000포인트)</p>
...
$(document).ready(function(){
	layerPopup.popupOpenNow('.textReview-pop'); 
	//별점
