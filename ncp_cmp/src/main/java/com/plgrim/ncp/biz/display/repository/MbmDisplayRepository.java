...
@Slf4j
@Repository
public class MbmDisplayRepository extends AbstractRepository {
	@Cacheable(value="mbmDisplayRepository.lnbCtgryList",
			key="{" + "#p0.lang,"
					+ "#p0.upperCategory,"
					+ "#p0.ctgryDpthCd,"
					+ "#p0.bstGodEvlYn"
	...
	@Cacheable(value="mbmDisplayRepository.selectLeafCtgryList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.upperCategory"
	...
	@Cacheable(value="mbmDisplayRepository.selectCtgryList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectDisplayGodList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.prcSectCd,"
	...
	@Cacheable(value="mbmDisplayRepository.selectFilterList",
			key="{" + "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.filterType"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerList",
			key="{"+ "#p0.lang,"
					+ "#p0.device,"
					+ "#p0.dspCtgryNo"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerGrpList",
			key="{"+ "#p0.lang,"
					+ "#p0.device,"
					+ "#p0.dspCtgryNo"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerCnrList",
			key="{"+ "#p0.lang,"
					+ "#p0.device,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.cnrSn"
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerSetList",
			key="{" + "#p0.lang,"
					+ "#p0.cnrSn,"
					+ "#p0.cnrTpGrpSn,"
					+ "#p0.dspCtgryNo,"
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerConttList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.cnrSn,"
					+ "#p0.cnrSetSn,"
	...
	@Cacheable(value="mbmDisplayRepository.selectCategoryCornerGodConttList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.cnrSn,"
					+ "#p0.cnrSetSn,"
	...
	@Cacheable(value="mbmDisplayRepository.selectMainCornerConttList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.cnrSn,"
					+ "#p0.cnrSetSn,"
...
/*	@Cacheable(value="mbmDisplayRepository.searchDisplayGodList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.prcSectCd,"
	...
	@Cacheable(value="mbmDisplayRepository.selectRecoPickGodList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.mallGubun,"
	...
	@Cacheable(value="mbmDisplayRepository.selectDisplayReviewList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.bstGodEvlYn,"
	...
	@Cacheable(value="mbmDisplayRepository.selectDisplayBestReviewList",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.bstGodEvlYn"
	...
	@Cacheable(value="mbmDisplayRepository.selectDspUseGrpTpCd",
			key="{"
					+ "#p0.dspUseGrpTpCd"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.mypageLnbCurrentCtgryList",
			key="{" 
					+ "#currentUri"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectGNBCategotyList",
			key="{" 
					+ "#p0.getLang()"
					+ "}")
	...
	@Cacheable(value="mbmDisplayRepository.selectCategotyNavi",
			key="{"
					+ "#p0.lang,"
					+ "#p0.mallGubun,"
					+ "#p0.ctgrySectCd"
	...
	@Cacheable(value="mbmDisplayRepository.selectCategotyNaviNm",
			key="{"
					+ "#p0.lang,"
					+ "#p0.dspCtgryNo,"
					+ "#p0.mallGubun,"
	...
	public List<DspCtgryGodFoResult> selectMainRankingGod(DspCtgryScFrDTO dspCtgryScFrDTO) throws Exception {		
		List<DspCtgryGodFoResult> result = getSession1().selectList("com.plgrim.ncp.biz.mall.display.selectMlbMainRankingGod", dspCtgryScFrDTO);		
		return result;
	}
