...
public class DlivyWmsSDO extends InterfaceBaseSDO{
	...
	private List<DlivyDrctSDO> releaseList;
	
	@JsonProperty("RESPONSE_DATA")
	private List<DlivyDrctSDO> responseData;
	
	@JsonProperty("OUTB_CMPT_CANCEL_YN")
	private String outbCmptCancelYn;
}
